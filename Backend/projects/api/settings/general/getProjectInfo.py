...
class GetProjectGeneral(APIView):
    ...
    def post(self, request):
        ...
        return Response({
            ...
            "users": project.user.count(),
            "roles": project.projectroles.count(),
            "folders": project.projectfolders.count(),
            "files": project.projectfiles.count(),
            "isCreator": project.creatorole.users.filter(username=request.user.username).exists(),
            "usersData": usersData
        })